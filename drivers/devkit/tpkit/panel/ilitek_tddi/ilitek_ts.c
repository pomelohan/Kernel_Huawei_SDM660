...
static int ilitek_input_config(struct input_dev *input_dev)
{
    ...
    if (g_ilitek_ts->use_ic_res) {
        g_ilitek_ts->x_max = g_ilitek_ts->cfg->tp_info.nMaxX;
        g_ilitek_ts->y_max = g_ilitek_ts->cfg->tp_info.nMaxY;
        g_ilitek_ts->x_min = g_ilitek_ts->cfg->tp_info.nMinX;
        g_ilitek_ts->y_min = g_ilitek_ts->cfg->tp_info.nMinY;
        g_ilitek_ts->finger_nums = g_ilitek_ts->cfg->tp_info.nMaxTouchNum;
    }

    g_ilitek_ts->ts_dev_data->x_max = g_ilitek_ts->x_max;
    g_ilitek_ts->ts_dev_data->y_max = g_ilitek_ts->y_max;
    g_ilitek_ts->ts_dev_data->x_max_mt = g_ilitek_ts->x_max;
    g_ilitek_ts->ts_dev_data->y_max_mt = g_ilitek_ts->y_max;
    ...
    input_set_abs_params(input_dev, ABS_MT_POSITION_X, g_ilitek_ts->x_min, g_ilitek_ts->x_max - 1, 0, 0);
    input_set_abs_params(input_dev, ABS_MT_POSITION_Y, g_ilitek_ts->y_min, g_ilitek_ts->y_max - 1, 0, 0);
    ...
    input_set_abs_params(input_dev, ABS_MT_TRACKING_ID, 0, g_ilitek_ts->finger_nums, 0, 0);
